...
# Defines a supported file format to export attribute data to
AttributeToFileSupportedFormat = namedtuple("AttributeToFileSupportedFormat", [
    "friendly_name",
    "description",
    "file_format",
    "supports_import",
...
# Defines all supported file formats to export attribute data to
attribute_to_file_supported_formats = {
    'PNG': AttributeToFileSupportedFormat(
        friendly_name="PNG (Image)",
        description="Image",
        file_format="png",
        supports_import = False,
        supports_export = True
    ),
    'CSV': AttributeToFileSupportedFormat(
        friendly_name="CSV (Data Table)",
...
# Defines a csv file layout
CSVFileLayout = namedtuple("CSVFileLayout", [
    "friendly_name",
    'description',
    "column_names"
])

# Defines all csv file format presets
csv_file_layouts = {
    "default": CSVFileLayout(
        friendly_name="Default",
        description="Default layout",
        column_names=['Name', 'Domain', 'Data Type', 'Data']
    ),
    "no_data": CSVFileLayout(
        friendly_name="No data",
        description="Only attribute name, domain and data type",
        column_names=['Name', 'Domain', 'Data Type']
    ),
    "name_and_data": CSVFileLayout(
        friendly_name="Name and data",
        description="Only name and data",
        column_names=['Name', 'Data']
    ),
}